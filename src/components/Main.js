...
const [showdata, setShowData] = useState(false);
  ...
  return (
    <div className='mt-28'>
      ...
      <div>
        <ul className='flex max-md:flex-wrap justify-center gap-2  items-center'>
      ...
      <div className='flex justify-center items-center mt-4 max-md:flex-wrap'>
        ...
        <div className='flex max-md:flex-[1_1_20rem]'>
          <div className='h-[2.3rem] pt-1 border-black border-[1px] border-r-[0px] rounded-l-full text-[#495057] '>
            <span className='cursor-pointer pl-2 pr-1'>All <AiFillCaretDown className='inline' /></span>
         </div>
          <input type="text" placeholder='type a keyword and press enter' className='max-md:flex-[1_1_20rem] h-[2.3rem] border-black border-[1px] border-r-[0px] pl-2 focus:outline-none focus:border-[#6610f2] max-md:border-r-[1px] max-md:rounded-r-full' />
    </div>
          <input type="text" placeholder='Global / Worldwide (All Countries)' className='max-md:flex-[1_1_20rem] w-[18rem] h-[2.3rem] border-black border-[1px] pl-2 max-md:rounded-full border-r-[0px] focus:outline-none max-md:rounded-l-full max-md:mt-4' />
          <select className='max-md:flex-[1_1_20rem] w-[8rem] h-[2.3rem] max-md:rounded-full focus:outline-none border-black border-[1px] max-md:mt-4 border-r-[0px] text-[#495057] cursor-pointer'>
       ...
       <div className='h-[2.3rem] ml-0 pr-2 pt-1 border-[#6610f2] border-[2px] bg-[#6610f2] max-md:flex-[1_1_20rem] text-white rounded-r-full max-md:hidden'>
